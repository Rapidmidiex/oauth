...
const SessionName = "_rmx_oauth_session"
...
func GetAuthURL(res http.ResponseWriter, req *http.Request) (string, error) {
	...
	provider, err := rmxOAuth.GetProvider(providerName)
	if err != nil {
		return "", err
	}
...
See https://github.com/markbates/goth/examples/main.go to see this in action.
*/
var CompleteUserAuth = func(res http.ResponseWriter, req *http.Request) (rmxOAuth.User, error) {
	if !keySet && defaultStore == Store {
		fmt.Println("goth/gothic: no SESSION_SECRET environment variable is set. The default cookie store is not available and any calls will fail. Ignore this warning if you are using a different store.")
	}
...
func validateState(req *http.Request, sess rmxOAuth.Session) error {
...
func getProviderName(req *http.Request) (string, error) {
	...
	providers := rmxOAuth.GetProviders()
